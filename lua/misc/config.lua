...
inoremap <C-b> \textbf{}<C-O>F{<C-O>l
inoremap <C-l> \textit{}<C-O>F{<C-O>l
inoremap <C-e> \emph{}<C-O>F{<C-O>l
inoremap <C-u> \underline{}<C-O>F{<C-O>l
...
" directory
nnoremap <Space>CC :sp<bar>terminal<CR>i<C-l>make -k -C `upsearch Makefile`
...
nnoremap <C-p>fg    <cmd>Telescope live_grep<cr>
nnoremap <C-p>fb    <cmd>Telescope buffers<cr>
nnoremap <C-p>fh    <cmd>Telescope help_tags<cr>
