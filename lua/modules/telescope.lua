...
vim.keymap.set('n', '<C-p><C-g><C-p>', function() return require'telescope'.extensions.repo.cached_list{file_ignore_patterns={"/%.cache/", "/%.cargo/", "/%.local/share/", "/%.zsh/"}} end)
vim.keymap.set('n', '<C-p><C-g><C-b>', function() return require('telescope.builtin').git_branches() end)
vim.keymap.set('n', '<C-p><C-g><C-d>', function() return require('telescope.builtin').git_commits()  end)
